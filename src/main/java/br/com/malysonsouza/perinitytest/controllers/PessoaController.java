...
public class PessoaController {
    ...
    @PostMapping
    public ResponseEntity<Pessoa> addPessoa(@RequestBody PessoaDTO dto) throws Exception {
        return new ResponseEntity<>(service.salvar(dto, 0L), HttpStatus.OK);
    }

    @PutMapping("/{id}")
    public ResponseEntity<Pessoa> alterarPessoa(@PathVariable("id") Long id, @RequestBody PessoaDTO dto) throws Exception {
